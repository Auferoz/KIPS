<?php
	...
	function rutExiste($rut)
	{
		...
		$stmt = $mysqli->prepare("SELECT id FROM usuarios WHERE rut = ? LIMIT 1");
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Host = 'mail.kips.cl'; //Modificar
		$mail->Port = 587; //Modificar
		
		$mail->Username = 'contacto@kips.cl'; //Modificar
		$mail->Password = '$kips2020A'; //Modificar
		
		$mail->setFrom('contacto@kips.cl', 'KIPS'); //Modificar
